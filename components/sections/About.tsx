          ...
          <div className="flex-1">
            <div className="overflow-hidden rounded-3xl">
              <Image
                ...
                className="rounded-3xl shadow-2xl object-cover transition-transform duration-500 hover:scale-105"
              />
            </div>
          </div>
          <div className="flex-1">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-xl leading-relaxed pb-10">
              ...
              design every detail to create beautiful and unforgettable moments.
            </p>
          </div>
        </div>
      </Container>
